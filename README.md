...
1. **Propofol anesthesia** (OpenNeuro ds005620)  
...
2. **DMT inhalation** (Pallavicini et al., 2021; Zenodo 3992359)  
   - Baseline vs. DMT.  
   - Characterizes **expanded repeller states** – consciousness with altered/dissolved body schema.

3. **Meditation** (e.g., focused attention vs. mind-wandering)  
...
4. **Auto-detect + manual confirm bad channels**
   - Heuristics:
...
8. **Filtered data inspection (manual)**
   - Second interactive plot to identify **bad time segments**:
     - movement,
     - electrode pops,
     - muscle bursts.

9. **Auto-detect + manual confirm bad segments**
   - Mark segments where:
...
- [x] DMT preprocessing pipeline with publication-grade logging.
- [x] Propofol analysis framework.
